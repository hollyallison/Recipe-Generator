...
function generateRecipe(event) {
    ...
    let context = "Follow user instructions and display the answer in html format where title of the recipe is included in class element named title, ingredients and quantities in class element named ingredients using list format <ul><li></li><li></li><li></li><li><li> <li></li></ul> using the heading ingredients. Put cooking instructions in class element named method with numbers for each step. Please always start class element method with Cooking Method in the top line. Please RESPECT the css for EACH class and keep this css consistent";
